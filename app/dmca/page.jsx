...
export const metadata = {
  ...
  description:
    "Digital Millennium Copyright Act (DMCA) notice, takedown, and counter-notice procedure for Shopyor.",
        ...
        <div className="space-y-6">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              Millennium Copyright Act (DMCA), we respond promptly to valid
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-3">
              If you believe your copyrighted work has been used through our
              service in a way that infringes your rights, please provide our
              agent with:
            </p>
