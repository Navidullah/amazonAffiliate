// app/admin/blogs/new/page.jsx (Create new blog)
"use client";
    ...
    <div className="min-h-screen bg-background py-16 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium mb-2">
              Content * (Use HTML or plain text)
            </label>
            <textarea
              ...
              placeholder="Write your blog content here. You can use HTML tags for formatting (e.g., <b>bold</b>, <i>italic</i>, <ul><li>list</li></ul>)"
              required
            />
          </div>
