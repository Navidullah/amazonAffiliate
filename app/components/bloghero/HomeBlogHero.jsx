...
export default function HomeHero({ postsCount = 0 }) {
  return (
    <section className="relative overflow-hidden rounded-2xl border border-white/10 bg-background dark:bg-gradient-to-b from-cyan-500/10 via-transparent to-transparent p-8 sm:p-12">
      {/* soft glow */}
      <div
        aria-hidden="true"
