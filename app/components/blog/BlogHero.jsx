...
export default function BlogHero() {
  return (
    <motion.section
      ...
      className="w-full mb-8 px-8 py-16 flex flex-col items-center text-center min-h-[38vh] md:min-h-[48vh] relative overflow-hidden bg-white/30 dark:bg-zinc-900/30 border border-white/40 dark:border-zinc-800/40 backdrop-blur-md shadow-lg"
    >
      <motion.h1
