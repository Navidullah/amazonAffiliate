...
// If you're pasting into app/tools/bmi/page.jsx, you can optionally export SEO metadata:
export const metadata = {
  title: "BMI Calculator | Health Tool",
  description:
    "Fast, accurate BMI calculator with metric & imperial units. Understand your weight category and healthy ranges.",
  keywords: [
    "BMI calculator",
    "body mass index",
    "metric bmi",
