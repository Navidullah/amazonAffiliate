...
const CopyrightNotice = dynamic(
  () =>
    import("@/app/components/copyright/CopyrightNotice").then(
      (mod) => mod.CopyrightNotice,
    ),
  { ssr: false },
);

// Skeleton loader for VideoDownloader
  ...
  return (
    <div className="min-h-screen bg-background py-12 px-4">
      <div className="container mx-auto max-w-4xl">
            ...
            <Card className="group hover:shadow-lg transition-all duration-300">
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Get your download links in seconds with our optimized
                    servers
                  </p>
                </div>
              </CardContent>
        ...
        {/* Usage Instructions with semantic HTML */}
        <section aria-labelledby="instructions-heading" className="mt-12">
