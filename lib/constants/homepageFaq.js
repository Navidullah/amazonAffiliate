...
export const HOMEPAGE_FAQ = [
  {
    ...
    answer:
      "Shopyor's main focus is fully worked exam solutions — Cambridge IGCSE Mathematics 0580 past papers and IB Mathematics AA HL Paper 1-style practice questions — every question solved step-by-step in mark-scheme order (M1/A1/R1 for IB) with an examiner tip on common mistakes. Alongside these, Shopyor also sells UK KS2 Year 6 Maths worksheets with worked examples, working space, and a full answer key. All resources download as PDFs.",
  },
  {
  ...
  {
    question: "Are the IB Maths questions from an official past paper?",
    answer:
      "No — the IB Maths packs are original Shopyor practice questions written to match the topics, style, and mark allocations of the real IB Mathematics AA HL Paper 1 format, with each step tagged M1/A1/R1 exactly as an IB examiner would award it. They are not sourced from an official or leaked IB past paper, and are designed to give students realistic practice ahead of the real exam. Not affiliated with or endorsed by the International Baccalaureate Organization (IBO).",
  },
  {
