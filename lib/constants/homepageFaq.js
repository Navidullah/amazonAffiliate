...
export const HOMEPAGE_FAQ = [
  {
    ...
    answer:
      "Two kinds of printable PDF: UK KS2 Year 6 Maths worksheets, and Cambridge IGCSE worked past-paper solutions (currently IGCSE Mathematics 0580, with more papers and IB Maths resources planned). Each Year 6 pack includes worked examples, working space, and a full answer key; each IGCSE pack includes every question solved step-by-step in mark-scheme order with an examiner tip on common mistakes.",
  },
  {
