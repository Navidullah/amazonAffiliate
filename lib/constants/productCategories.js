...
export const CATEGORIES = [
  ...
  { value: "gcse-maths", region: "uk", label: "GCSE Maths" },
  { value: "us-common-core-math", region: "us", label: "Common Core Math" },
  { value: "ca-provincial-math", region: "ca", label: "Provincial Math" },
  { value: "igcse-maths", region: "international", label: "IGCSE Maths" },
  { value: "ib-aahl-maths", region: "international", label: "IB Maths AA HL" },
];

// Cuts across regions/categories: lets the storefront surface every past-paper
// worked-solutions product (IGCSE, IB, GCSE, ...) in one filter regardless of
// curriculum. A product opts in by setting `contentType: "past-paper-solutions"`.
export const CONTENT_TYPES = [
  { value: "past-paper-solutions", label: "Past Paper Worked Solutions" },
